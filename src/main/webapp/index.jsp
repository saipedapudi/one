...
<body>
	...
	<h2 style="color: green; font-size: 40px;" align="center">THIS IS MY DEPLOYMENT</h2>
	<h2 style="color: orange; font-size: 40px;" align="center">WE INTEGRATED NEXUS WITH JENKINS</h2>
